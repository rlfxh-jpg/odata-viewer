<template>
    <div class="action-import-detail" v-if="data">
        <!-- 头部信息 -->
        <div class="header">
            <div class="title-row">
        ...
        <el-card class="section-card" shadow="never">
            ...
            <el-descriptions :column="1" border>
                ...
                <el-descriptions-item label="关联 Action">
                    <el-link type="primary" @click="handleJump(data.action)">
                        {{ data.action }}
                    </el-link>
...
interface Props {
    data: any // 接收 ActionImport 的 JSON 对象
}
